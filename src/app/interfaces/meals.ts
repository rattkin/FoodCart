...
export const Meals: Meal[] = [
    ...
    },
    {
        ...
        name: 'Paneer Saslik',
        description: 'Grilované sýrové kostky, grilovaná cibule a rajčata a 2 druhy chutney.',
        allergen: '7',
        weight: '200g',
        price: 145,
        packaging: 5,
        ...
        type: 'meal',
        class: 'vege',
        tags: ['NOVINKA!', 'pro vegetariány', 'Specialita kuchaře'],
        photo: 'assets/chicken saslik.jpg',
    }, {
        name: 'Chicken Thali',
    ...
    {
        name: 'Lassi Koktejl',
        description: 'V indii velmi populární osvěžující jogurtový nápoj. Mùžete si vybrat mango, sladkou nebo slanou variantu.',
        allergen: '7',
        price: 40,
        type: 'meal',
        class: 'drink',
    ...
    {
        name: 'Ginger Beer',
        description: 'Zázvorová limonáda',
        price: 45,
        type: 'meal',
        class: 'drink',
    ...
    },
    {
        ...
        description: 'Tradiční indický čaj s mlékem a kořením',
        allergen: '7',
        price: 40,
        type: 'meal',
        class: 'drink',
    ...
    },
    {
        ...
        description: 'Jen málokterý pivovar ve střední Evropě se může pochlubit takovou tradicí jako třeboňský pivovar, který byl založen roku 1379.',
        allergen: '1',
        price: 35,
        type: 'meal',
        class: 'drink',
